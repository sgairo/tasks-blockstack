        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <form @submit.prevent="addTodo" :disabled="! todo">
            <div class="input-group">
              <input v-model="todo" type="text" class="form-control" placeholder="Write a task..." autofocus>
	      <input v-model="estimate" type="number" class="form-control" placeholder="estimate"  autofocus>
	      <input v-model="assigned" type="text" class="form-control" placeholder="Who is assigned this task" autofocus>
